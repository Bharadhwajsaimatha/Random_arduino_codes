...
/* 
  ...
  1    = Total number of meSerial1ages of this type in this cycle
  2    = MeSerial1age number
...
void Display()
{
   //Serial.println(F("Sats=")); Serial.println(gps.satellites.value());
   
 // Serial.println("Entered Display");
