...
//#include <Left_side_wing_GPS.ino>
...
void displayInfo(TinyGPSPlus temp)
{
  TinyGPSPlus gps = temp;
  Serial.print(F("Sats=")); 
...
//      {  
//      //Serial.println("entered serial");
//      if (GPS_LW.encode(Serial1.read()))
//      {
//          //Serial.println("reading");
//          displayInfo(GPS_LW);
//      }
//      if (millis() > 20000 && GPS_LW.charsProcessed() < 10)
//      {
//        Serial.println(F("No GPS detected: check wiring."));
//        //while(true);
//      }
