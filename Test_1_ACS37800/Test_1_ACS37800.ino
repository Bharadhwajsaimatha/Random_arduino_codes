...
const uint8_t I2CAddress = 96;
// const uint16_t DIO_1 = 4;
...
const uint32_t DIO_0 = 16; // PA6
const uint32_t DIO_1 = 17; // PA7
...
void loop()
{
  ...
  uint32_t Settings3;
    ...
    if (nextTime < millis())
    { 
        Write(0x0E, 0x00021C00);
        Write(0x0F, 0x01081783);
